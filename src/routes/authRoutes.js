...
router.post('/register-company', registerLimiter, registerCompanyAndAdmin);
router.post('/login', loginLimiter, login);

// --- RUTAS CORREGIDAS ---
router.post('/forgot-password', forgotPasswordLimiter, solicitarRecuperacion); // Sin el prefijo authController
